...
export const getAttachmentUrl = (attachment: Attachment) => {
  ...
  return `${API_BASE_URL}/file/${attachment.name}/${attachment.filename}`;
};

export const getAttachmentThumbnailUrl = (attachment: Attachment) => {
  return `${API_BASE_URL}/file/${attachment.name}/${attachment.filename}?thumbnail=true`;
};

export const getAttachmentMotionClipUrl = (attachment: Attachment) => {
  return `${API_BASE_URL}/file/${attachment.name}/${attachment.filename}?motion=true`;
};
